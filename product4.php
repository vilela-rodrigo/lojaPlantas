...
<main>
  <div class="row">
    <div class="col-lg-6 col-md-7 highlight">
      <img width="100%" src="./assets/images/plantaQualquer4.jpg" />
    </div>

    <div class="col-md-5 mt-5 product-page-info">
      <h2>Monstera Deliciosa</h2>
      <p>Nicknamed the “swiss cheese plant”, the Monstera deliciosa is famous for its quirky natural leaf holes.</p>
