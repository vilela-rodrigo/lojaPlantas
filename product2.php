...
<main>
  <div class="row">
    <div class="col-lg-6 col-md-7 highlight">
      <img width="100%" src="./assets/images/plantaQualquer2.jpg" />
    </div>

    <div class="col-md-5 mt-5 product-page-info">
      <h2>ZZ Plant</h2>
      <p>The ZZ Plant is characterized by its thick waxy green leaves. It is a great air purifying plant for beginners. This makes a great gift for a new grad!</p>
